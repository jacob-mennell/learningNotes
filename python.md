...
Alternatively, immutable objects (integers, strings and tuples) cannot be changed after they are created. In this case, we pass the value not the object itself so the original object cannot be modified by the function, named 'pass by object'.
